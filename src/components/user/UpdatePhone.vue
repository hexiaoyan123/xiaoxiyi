  ...
  <div class="container address-list" style="overflow: hidden;">
    ...
    <div class="card" style="overflow: hidden;">
      ...
      <div v-show="isFirstUpdatePhone == false">
        ...
        <p style="font-size: 3.2vw; color: #818181; margin: 5px 10px;">您当前绑定的手机号为{{phone}}，若继续使用该手机则无需修改</p>
      ...
      <div class="form-btn" @click="updateUserPhone">立即绑定</div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    updateUserPhone() {
      ...
      this.$http
        .post("/v1/updateUserPhone", postData)
        .then(function(response) {
          if ("1000" == response.data.code) {
            vm.$toast("绑定成功！");
